...
\title{Solving partial NP-complete problems on distributed networks}
...
settings,\footnote{One of these, the {\texttt{\char'134 alignauthor}} command, you have
...
or explanations of such commands. Section~\ref{main} introduces the main
...
As a rule you'd prefer \texttt{{\char'134}emph} (which stands for \emph{emphasize})
over something like \texttt{{\char'134}textit} since that gives the typesetting system
...
It is recommended that you precede \texttt{{\char'134}cite} commands with a tilde
character instead of a space, e.g., \texttt{some text\textasciitilde{\char'134}cite}. The tilde gives you a non-breaking space which ensures that your citation won't get
