...
technique used by LoRa is called chirp spread spectrum, and it is slightly 
different from SigFox's UNB modulation technique.

\begin{figure}[htbp]
  \centering
  \fbox{\includegraphics[width=.9\columnwidth]{LoRa Network Stack.png}}
  \caption{LoRaWAN network Stack\cite{LoRa_Alliance®_2023}}
  \label{fig:LoRaWAN_network}
\end{figure}

\subsection{Traditional Wifi}
\label{subsec:Traditional Wifi}
